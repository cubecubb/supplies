...
public class new_supplier extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    new_supplier.MyTask mt;
    new_supplier.MyTaskN mtn;
    new_supplier.MyTaskTF mttf;
    ListView lvMain;
    //    String ID;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mt = new new_supplier.MyTask();
        mt.execute();

    }
    public void onClick4(View v) {
        mtn = new new_supplier.MyTaskN();
...
//        lvMain.getCheckedItemPositions();
    ...
    class MyTaskTF extends AsyncTask<String, Void, Void > {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                URL githubEndpoint = new URL("http://172.20.10.3:8080/supplies/");
                myConnection =
            ...
            try {
                myConnection.getOutputStream().write(("ID=2&ID_supplier=" + params[0]+"&ID_product="+params[1]).getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            };
...
//            ID=result;
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (ch.isChecked()){
                    mttf = new new_supplier.MyTaskTF();
    ...
    class MyTask extends AsyncTask<Void, Void, ArrayList<String[]> >{
        ...
        protected ArrayList<String[]> doInBackground(Void... params) {
            ...
            HttpURLConnection myConnection = null;
            try {
                URL githubEndpoint = new URL("http://172.20.10.3:8080/supplies?ID=2");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
...
//                        sb.append("\r\n : " +value);
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            super.onPostExecute(result);
            new_supplier.ClAdapter clAdapter=new new_supplier.ClAdapter(tvInfo.getContext(),result);
//            lvMain = (ListView) findViewById(R.id.lvMain);
