...
public class supplier extends AppCompatActivity {
    ...
    public void onClick1(View v){
        supplier.MyTask mt = new supplier.MyTask();
    ...
    class MyTask extends AsyncTask<String,Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(String... params) {
            ...
            try {
                URL mySite = new URL("http://192.168.187.70:8080/supplies?ID=2&Name="+params[0]);
        ...
        protected void onPostExecute(ArrayList<String[]> result){
            ...
            supplier.ClAdapter clAdapter = new supplier.ClAdapter(tvInfo.getContext(),result);
    ...
    class ClAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            ((TextView) view.findViewById(R.id.tvText1)).setText(p[1]);            ((TextView) view.findViewById(R.id.tvText2)).setText(p[2]);
            return view;
        };
    }
}